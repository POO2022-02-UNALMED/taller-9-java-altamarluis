...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public Calculator(){
        ...
        public String organizarNumero(String s){
            if (number1.isEmpty()){
                number1 = s;
            } else {
                number2 = s;
        ...
        public String organizarOperador(String s){
            operator = s;
            return number1 + operator + number2;
        }
	...
	public void handle(ActionEvent event) {
		...
		String value = b.getText();
            ...
            switch (value) {
                case "0":
                    displayText.setText(organizarNumero(value));
                    break;
                case "1":
                    displayText.setText(organizarNumero(value));
                    break;
                ...
                case "9":
                    ...
                    break;
                case "/":
                    displayText.setText(organizarOperador(value));
                    break;
                case "*":
                    displayText.setText(organizarOperador(value));
                    break;
